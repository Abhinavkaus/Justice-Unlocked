...
class ProfileSuspect extends StatefulWidget {
  ...
  ProfileSuspect({this.currentUserID, this.preSuspectAccount});
                ...
                children: [
                  ...
                  Container(
                    child: InputBox(
                      bottomMargin: 15,
                      labelText: "Full Name",
                      initialValue: widget.preSuspectAccount != null
                          ? widget.preSuspectAccount!.fullName
                          : '',
                  ...
                  Container(
                    child: InputBox(
                      ...
                      textInputType: TextInputType.text,
                      initialValue: widget.preSuspectAccount != null
                          ? widget.preSuspectAccount!.address
                          : '',
                      textInputAction: TextInputAction.next,
                      focusNode: addressFN,
                  ...
                  Container(
                    child: InputBox(
                      ...
                      textInputAction: TextInputAction.next,
                      initialValue: widget.preSuspectAccount != null
                          ? widget.preSuspectAccount!.caseSection
                          : '',
                  ...
                  Container(
                    child: InputBox(
                      ...
                      textInputAction: TextInputAction.next,
                      initialValue: widget.preSuspectAccount != null
                          ? widget.preSuspectAccount!.caseNumber
                          : '',
                      focusNode: caseNoFN,
