...
import 'package:crimo/pages/court/courtCaseInformation.dart';
import 'package:flutter/material.dart';

class CourtCaseWidget extends StatelessWidget {
  final SuspectAccount suspectAccount;
  CourtCaseWidget({required this.suspectAccount});
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () => Navigator.of(context).push(
        MaterialPageRoute(
          builder: (context) => CourtCaseInformation(
